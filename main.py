...
def btnClick(buttons):
    ...
    if buttons["text"] == " " and bclick == True:
        ...
        tkinter.messagebox.showinfo("Info", "Already taken!")
...
def checkForWin():
    if (button1['text'] == 'X' and button2['text'] == 'X' and button3['text'] == 'X' or
        ...
        disableButton()
        tkinter.messagebox.showinfo("Info", pa)

    elif(flag == 8):
        tkinter.messagebox.showinfo("Info", "It is a Tie")
        ...
        disableButton()
        tkinter.messagebox.showinfo("Info", playerb)
